        ...
        <div className="flex w-full pt-8 justify-between items-center">
          <div className="w-[40%]">
            ...
            <p className="text-[#514E4E] font-sans">
              Blok L8, Delta Silicon Industrial Park, Jl. Kruing 3 No.5A,
              Sukaresmi, Cikarang Sel., Kabupaten Bekasi, Jawa Barat 17550
            </p>
          </div>
                ...
                <tr>
                  ...
                  <td className="border border-gray-100 bg-gray-50 text-start text-blue-500 flex  ">
                    <div className="px-4 py-2 w-1/3 border-r border-gray-100">
                      <p className="text-blue-500">{datas?.machine?.no}</p>
                    </div>
                  ...
                  <td className="border border-gray-100 bg-gray-50 text-start text-blue-500 flex  ">
                    <div className="px-4 py-2 w-1/3 border-r border-gray-100">
                      <p className="text-blue-500">
                        {datas?.created_at &&
                          moment(datas?.created_at).format("L")}
                      </p>
                    </div>
                    <div className="px-4 py-2">
                      <h1 className="font-semibold text-black">
                    ...
                    return (
                      <>
                        {i > 0 ? (
                          <>
                            <tr>
                              <th
                                colSpan={2}
                                className="text-center w-1/2  py-6"
                              ></th>
                              <th
                                colSpan={2}
                                className="text-center w-1/2 py-6"
                        ...
                        <tr>
                          <th
                            colSpan={2}
                            className="text-center w-1/2 border border-gray-100 py-4 bg-[#E8F8FB]"
                          >
                            Actual Result
                          </th>
                          <th
                            colSpan={2}
                            className="text-center w-1/2 border border-gray-100 py-4 bg-[#FEF4E6]"
                          >
                            SA Result
                          </th>
                        </tr>
