    ...
    <div className="text-[#514E4E] font-open-sans">
      ...
      <div className="m-auto w-full border border-[#D0D3D9] rounded-md">
        <div className="w-full flex justify-between items-center px-8 py-6">
          <h1 className="font-[700] text-2xl text-gray-700">
            Part Check Report - {model.part.partCode}
          </h1>
          <div className="w-1/2 flex justify-end gap-3">
            ...
            >
              <div className="flex items-center justify-center border-[#667085] gap-3 outlet-none">
          ...
          <table className="w-full">
            <thead className="bg-[#FAFAFB] border-y border-[#D0D3D9]">
              <tr className="text-sm">
                <th className="px-8 py-[22px] text-left font-[600]">
                  ID Report
                </th>
            ...
            <tbody>
              {model.reportDetail.data.map((item, index) => (
                <tr className="border-b border-[#D0D3D9]">
                  ...
                  <td className="px-8 py-[22px] items-center">
                  ...
                  <td className="px-8 py-[22px] flex justify-start items-center">
                    <button
