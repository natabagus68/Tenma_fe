import useReportDetail from "../report-detail/report-detail-model";

export const DownloadModal = ({ model = useReportDetail() }) => {
    return (
        model.DownloadModalShow && (
                    ...
                    <form className="m-auto">
                        <div className="flex flex-col bg-white rounded-3xl shadow-[0px_20px_24px_-4px_rgba(16,_24,_40,_0.08),_0px_8px_8px_-4px_rgba(16,_24,_40,_0.03)] px-6 py-6">
                            ...
                            <div className="grid grid-cols-2 gap-3 mt-6">
                                ...
                                <button
                                    onClick={model.cancelModelDownload}
                                    className="rounded bg-white border border-[#B8B6B6] p-3 text-[#514E4E] text-sm font-semibold"
                                >
                                    Cancel
                                </button>
                            </div>
