    ...
    <div className="w-full overflow-hidden min-h-screen">
      ...
      <div className="flex flex-1 py-4 gap-3">
        ...
        <div className="flex flex-[1.5] items-center gap-2 text-[#514E4E]">
          ...
          <Datepicker
            inputClassName={
              "border border-[#D0D3D9] px-4 py-3 outline-none rounded-md w-[100%] text-sm"
            }
      ...
      <div className="bg-[#FFFFFF] border border-[#D0D3D9] rounded-md">
        ...
        <table className="w-full">
          <thead className="text-[#514E4E] bg-[#FAFAFB]">
            <th className="border-b border-[#D0D3D9] font-[600] text-left px-4 py-4">
              Update at
            </th>
            <th className="border-b border-[#D0D3D9] font-[600] text-left px-6 py-4">
              Date
            </th>
            <th className="border-b border-[#D0D3D9] font-[600] text-left px-6 py-4">
              Part Code
              ...
              ? model.traceability?.data.map((item, index) => {
                  return (
                    <tr key={index} className="text-[#514E4E]">
                      <td className="border-b border-[#D0D3D9] text-left px-6 py-4 font-[300]">
