          ...
          <div className=" w-full">
            <table className="w-full">
              <thead className=" border-y-2 border-gray-100">
                <tr>
                  <th className="py-6 px-6 text-start bg-gray-50">Date</th>
                  <th className="py-6 px-6 text-start bg-gray-50">
                    Problem Details
                  </th>
                  <th className="py-6 px-6 text-start bg-gray-50">Char</th>
                  <th className="py-6 px-6 text-start bg-gray-50">Remark</th>
                  <th className="py-6 px-6 text-start bg-gray-50">Action</th>
                </tr>
              </thead>
              <tbody>
                {model.histories.map((item) => (
                  <tr key={item.id}>
                    <td className="text-start px-6 border-b-2 border-gray-100 py-6">
