          ...
          <div className=" w-full">
            <table className="w-full">
              <thead className=" border-y">
                <tr>
                  <th className="py-6 text-start bg-gray-50">Date</th>
                  <th className="py-6 text-start bg-gray-50">Problem Details</th>
                  <th className="py-6 text-start bg-gray-50">Char</th>
                  <th className="py-6 text-start bg-gray-50">Remark</th>
                  <th className="py-6 text-start bg-gray-50">Action</th>
                </tr>
              </thead>
              <tbody>
                {model.histories.map((item) => (
                  <tr key={item.id}>
                    <td className="text-start border-b  py-6">
                      {moment(item.date).format("DD/MM/YYYY")}
                    </td>
                    <td className="text-start border-b  py-6">{item.problemDetail}</td>
                    <td className="text-start border-b  py-6">{item.char}</td>
                    <td className="text-start border-b  py-6">{item.remark}</td>
                    <td className="text-start border-b  py-6">
