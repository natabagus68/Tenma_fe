...
const PartFormView = () => {
  ...
  return (
    <div className="text-[#514E4E] font-open-sans">
      <Breadcrumbs
        items={["Part", `${partForm.partId ? "Edit Data" : "Add Data"}`]}
      />
          ...
          <form className="w-[80%]">
            <div className="flex flex-col gap-2 text-left my-2">
              ...
              <input
                ...
                onChange={(e) =>
                  partForm.onFormChange("custItemId", e.target.value)
                }
            ...
            <div className="flex flex-col gap-2 text-left my-2">
              ...
              <input
                ...
                onChange={(e) =>
                  partForm.onFormChange("partCode", e.target.value)
                }
                className="w-full border rounded-lg outline-none px-4 py-2 font-[#B8B6B6] border-[#D0D3D9] text-sm placeholder:text-[#B8B6B6]"
            ...
            <div className="flex flex-col gap-2 text-left my-2">
              ...
              <input
                ...
                onChange={(e) =>
                  partForm.onFormChange("partName", e.target.value)
                }
                className="w-full border rounded-lg outline-none px-4 py-2 font-[#B8B6B6] border-[#D0D3D9] text-sm placeholder:text-[#B8B6B6]"
            ...
            <div className="flex flex-col gap-2 text-left my-2">
              ...
              <input
                ...
                onChange={(e) =>
                  partForm.onFormChange("itemGroupCode", e.target.value)
                }
                className="w-full border rounded-lg outline-none px-4 py-2 font-[#B8B6B6] border-[#D0D3D9] text-sm placeholder:text-[#B8B6B6]"
            ...
            <div className="flex flex-col gap-2 text-left my-2">
              <label className="font-[400] text-[#514E4E]">
                Item Group Name
              </label>
              <input
                type="text"
                ...
                onChange={(e) =>
                  partForm.onFormChange("itemGroupName", e.target.value)
                }
            ...
            <div className="flex flex-col gap-2 text-left my-2">
              ...
              <input
                ...
                onChange={(e) =>
                  partForm.onFormChange("oldPartNumber", e.target.value)
                }
                className="w-full border rounded-lg outline-none px-4 py-2 font-[#B8B6B6] border-[#D0D3D9] text-sm placeholder:text-[#B8B6B6]"
            ...
            <div className="flex flex-col gap-2 text-left my-2">
              ...
              <select
                ...
                onChange={(e) =>
                  partForm.onFormChange("customerModelId", e.target.value)
                }
              >
            ...
            <div className="flex flex-col gap-2 text-left my-2">
              ...
              <select
                ...
                onChange={(e) =>
                  partForm.onFormChange("customerId", e.target.value)
                }
              >
                <option value="" disabled>
                  {" "}
            ...
            <div className="flex flex-col gap-2 text-left my-2">
              ...
              <select
                ...
                onChange={(e) =>
                  partForm.onFormChange("customerModelGroupId", e.target.value)
                }
              >
                {" "}
                <option value="" disabled>
            ...
            <div className="flex flex-col gap-2 text-left my-2">
              ...
              <select
                ...
                onChange={(e) =>
                  partForm.onFormChange("material", e.target.value)
                }
              >
                <option value="" disabled>
                  {" "}
            ...
            <div className="flex flex-col gap-2 text-left my-2">
              ...
              <div className="w-full bg-[#D0D3D9] rounded-lg outline-none px-4 py-2 tet-sm font-[400]">
                ...
                )?.materialDetail || <span className="text-[#D0D3D9]">-</span>}
              </div>
            </div>
            <div className="flex flex-col gap-2 text-left my-2">
              <label className="font-[400] text-[#514E4E]">
            ...
            <div className="flex flex-col gap-2 text-left my-2">
              ...
              <input
                ...
                onChange={(e) =>
                  partForm.onFormChange("unitCd", e.target.value)
                }
            ...
            <div className="flex flex-col gap-2 text-left my-2 text-[#514E4E]">
              ...
              <input
                ...
                onChange={(e) =>
                  partForm.onFormChange("productWeight", e.target.value)
                }
