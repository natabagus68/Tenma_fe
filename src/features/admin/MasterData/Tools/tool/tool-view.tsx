        ...
        <div>
          <table className="w-full">
            <thead className="bg-[#FAFAFB] border-y border-[#D0D3D9] text-[#514E4E]">
              <tr className="font[700] text-left">
                <th className="py-[22px] px-8">ID Tools</th>
                <th className="py-[22px] px-8">Tool Code</th>
                <th className="py-[22px] px-8">Name</th>
                <th className="py-[22px] px-8">Address</th>
                <th className="py-[22px] px-8">Action</th>
              </tr>
            </thead>
            <tbody>
