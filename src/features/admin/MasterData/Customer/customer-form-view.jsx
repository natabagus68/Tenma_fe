    ...
    <>
      ...
      <div className="m-auto w-full border border-[#D0D3D9] rounded-md">
        <div className="w-full flex justify-between items-center px-8 py-6">
          <h1 className="font-[700] text-2xl text-[#514E4E]">{customerForm.id ? "Edit Data" : "Add Data"}</h1>
        </div>
        <div className="border-t border-[#D0D3D9] px-8 py-3 text-[#514E4E]">
          <form onSubmit={customerForm.onSave}>
            <div className="flex flex-col gap-3">
              ...
              <input type="text" name="name"
                ...
                className="w-[80%] border border-[#D0D3D9] rounded-lg outline-none px-5 py-2 text-[#514E4E]"
              />
            </div>
