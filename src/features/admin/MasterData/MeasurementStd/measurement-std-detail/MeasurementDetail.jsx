    ...
    <div className="text-[#514E4E]">
      ...
      <div className="m-auto w-full border border-[#D0D3D9] rounded-md">
        <div className="w-full flex justify-between items-center px-8 py-[18px]">
          <h1 className="font-[700] text-2xl font-sans">Details</h1>
          ...
          <table className="w-1/4">
            <tbody>
              <tr className="bg-[#F0F1F3]">
                ...
                <td className="p-4">{model.measurement.part.partName}</td>
              </tr>
              <tr>
                <td className="p-4">Part Code (Item CD)</td>
                <td className="p-4">{model.measurement.part.partCode}</td>
              </tr>
              <tr className="bg-[#F0F1F3]">
                <td className="p-4">Model</td>
                <td className="p-4">{model.measurement.part.customerModel}</td>
              </tr>
            </tbody>
          </table>
        </div>
