        ...
        <>
          <div className="w-[40%] h-[50%] mx-auto flex flex-col overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none bg-[#FFFFFF] top-[32.5%] p-6 rounded-xl">
            <div className="flex flex-col items-center justify-center mt-2">
              <h1 className="text-2xl mb-1 font-[600] text-[#313030]">Add Nominal</h1>
              <p className="w-2/3 text-center mb-8 text-[#514E4E]">Add Nominal Parameter and input value except: Absolute (Good)</p>
            </div>
            <form className="w-full mb-8 ml-8">
              <div className="flex items-center mb-4">
                <label className="w-[25%] font-[600] text-[#514E4E]">Nominal type</label>
                <select
                  name="nominal"
                ...
                >
                  <option value={""} disabled>Select nominal type</option>
                  {[
                    "Absolute (Good)",
                    "ORR LESS",
                    "ORR OVER",
              ...
              <div className="flex items-center">
                <label className="w-[25%] font-[600] text-[#514E4E]">Nominal value</label>
                <input
                  type="text"
                  name="nominalValue"
