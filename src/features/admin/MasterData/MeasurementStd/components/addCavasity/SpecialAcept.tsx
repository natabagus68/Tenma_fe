          ...
          <table className="w-full">
            <thead>
              <tr className="text-sm font-[600]">
                <th
                  className="py-4 border-[#D0D3D9] border-b border-r"
                  colSpan={4}
                >
                  Standart
                </th>
                <th
                  className="py-4 border-[#D0D3D9] border-b border-r bg-[#FDDDB3]"
                  colSpan={2}
                >
                  Special Accept
                </th>
                <th
                  className="py-4 border-[#D0D3D9] border-b border-r bg-[#D0D3D9]"
                  rowSpan={2}
                >
                  Tools
                </th>
              ...
              <tr className="text-sm font-[600]">
                <th className="py-4 border-r border-[#F0F1F3] bg-[#D0D3D9]">
                  Character
                </th>
                <th className="py-4 px-8 border-b border-r border-[#F0F1F3] bg-[#D0D3D9]">
                  Nominal
                </th>
                <th className="py-4 border-b border-r border-[#F0F1F3] bg-[#D0D3D9]">
                  Upper
                </th>
                <th className="py-4 border-[#D0D3D9] border-b border-r bg-[#D0D3D9]">
                  Lower
                </th>
                <th className="py-4 border-[#D0D3D9] border-b border-r bg-gray-50">
                  Upper
                </th>
                <th className="py-4 border-[#D0D3D9] border-b border-r bg-gray-50">
                  Lower
              ...
              {model.measurementStd.segments.map((item, ind) => (
                <tr>
                  ...
                  <td className="py-4 border-t border-b border-[#D0D3D9] text-center px-4 text-sm">
                    <button
                      onClick={(e) => model.onRemoveSegment(e, ind)}
