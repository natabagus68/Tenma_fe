          ...
          <tbody>
            {
              model.segments.map((item) => {
                return (
                  <>
                    <tr>
                      <td className="py-4 border-t border-b border-[#D0D3D9] text-center">{item.character}</td>
                      <td className="py-4 border-l border-t border-[#D0D3D9] border-b text-center">{item.nominalValue}</td>
                      <td className="py-4 border-l border-t border-[#D0D3D9] border-b text-center">{item.upper}</td>
                      <td className="py-4 border-l border-t border-[#D0D3D9] border-b text-center">{item.lower}</td>
                      <td className="py-4 border-l border-t border-[#D0D3D9] border-b text-center">{item.saUpper}</td>
                      <td className="py-4 border-l border-t border-[#D0D3D9] border-b text-center">{item.saLower}</td>
                      <td className="py-4 border-l border-t border-[#D0D3D9] border-b text-center">{item.tool?.name}</td>
                    </tr>
                  </>
                );
              })
