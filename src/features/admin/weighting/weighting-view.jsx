  ...
  return (
    <div className="text-[#514E4E] font-open-sans">
      ...
      <div className="w-full border border-[#D0D3D9] rounded-md">
        <h1 className="font-[700] px-8 py-6 text-2xl border-b border-[#D0D3D9]">
          Add Data
        </h1>
          ...
          <div className="flex flex-col gap-2">
            ...
            >
              ...
              {model.transaction?.map((item) => {
                return (
                  <option value={item.id}>{item.progressTransactionID}</option>
                );
              })}
            </select>
          </div>
          ...
          <table className="w-full">
            <thead>
              <tr className="text-sm">
                <th className="px-8 py-[22px] text-left bg-gray-50 items-center">
                  Tools
                </th>
                <th className="px-8 py-[22px] text-left bg-gray-50 items-center">
                  ID Transaction
              ...
              {model.weighting?.map((item) => {
                return (
                  <tr>
                    ...
                    <td className="px-8 py-[22px] text-left border-b border-[#D0D3D9] items-center">
                      {" "}
                      {item.progressCheck.progress_transaction_id}{" "}
                    </td>
                    <td className="px-8 py-[22px] text-left border-b border-[#D0D3D9] items-center">
                      {" "}
                    ...
                    <td className="px-8 py-[22px] text-left border-b border-[#D0D3D9] items-center">
                      {" "}
                      {item.progressCheck?.actual_part_weight || ""}{" "}
                    </td>
                    <td className="px-8 py-[22px] text-left border-b border-[#D0D3D9] items-center">
