            ...
            <div className="flex-[50%] flex justify-center items-center md:p-10">
                <form onSubmit={ e => {
                    ...
                    <div className="bg-white shadow-[0px_0px_13px_rgba(4_67_50_0.15)] rounded-xl border-[1px] border-gray-100 py-[92px] px-10 md:px-[74px] md:w-[479px]">
                        <div className="font-rubik font-bold text-green-500 text-4xl">Welcome back.</div>
                        <div className="font-rubik text-gray-400 mb-[48px]">Log in to your account</div>
                        <div className="relative mb-[25px]">
                            ...
                            <input type="text" className="font-lato w-full border border-gray-300 rounded pl-10 pr-3 py-2" placeholder="Company Code" />
                        </div>
                        <div className="relative mb-[25px]">
                            <div className="absolute h-full flex items-center pl-3">
                            ...
                            <input type="email" className="font-lato w-full border border-gray-300 rounded pl-10 pr-3 py-2" placeholder="input your email" />
                        </div>
                        <div className="relative mb-[25px]">
                            <div className="absolute h-full flex items-center pl-3">
                            ...
                            <input type="password" className="font-lato w-full border border-gray-300 rounded pl-10 pr-3 py-2" placeholder="input password" />
                        </div>
                        <button className="font-lato font-bold bg-green-500 rounded text-white w-full py-2 px 5">Login</button>
                    </div>
                </form>
            </div>
        </>
