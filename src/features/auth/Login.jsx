                ...
                <form onSubmit={ (e) => {
                    ...
                    <div className="bg-white shadow-[0px_0px_13px_rgba(4_67_50_0.15)] rounded-xl border-[1px] border-gray-100 py-[92px] px-10 md:px-[74px] md:w-[479px]">
                        ...
                        <div className="relative mb-[25px]">
                            ...
                            <Input value={ form.email } onChange={ (e) => setForm((form) => ({ ...form, email: e.target.value, })) } type="email" className="pl-10 w-full" placeholder="input your email" />
                        </div>
                        <div className="mb-[25px]">
                            <div className="relative">
                                ...
                                <Input value={ form.password } onChange={ (e) => setForm((form) => ({ ...form, password: e.target.value, })) } type="password" className="pl-10 w-full" placeholder="input password" />
                            </div>
                            { authenticateError && <span className="text-red-700">{ authenticateError?.data?.message }</span> }
                        </div>
                        <button type="submit" className="font-body font-bold bg-green-500 rounded text-white w-full py-2 px 5" disabled={ authenticateLoading }>
                            Login
                        </button>
                    </div>
                </form>
